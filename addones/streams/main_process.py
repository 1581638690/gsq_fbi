...
# -*- coding: utf-8 -*- 
#xlink的py文件
#filename: main_process.xlk
#datetime: 2024-08-30T16:10:58.173821
#copyright: OpenFBI
...
#LastModifyDate:　2024-04-25T11:36:59    Author:   pjb

#LastModifyDate:　2024-04-02T11:44:59    Author:   lch

#LastModifyDate:　2024-04-01T15:20:34    Author:   lch

#LastModifyDate:　2024-04-01T11:17:27    Author:   superFBI

#LastModifyDate:　2024-03-30T14:24:25    Author:   lch

#LastModifyDate:　2024-03-29T17:26:54    Author:   lch

#LastModifyDate:　2024-03-27T16:34:07    Author:   lch

#LastModifyDate:　2024-03-27T15:50:07    Author:   lch

#LastModifyDate:　2024-03-27T10:39:53    Author:   superFBI

#LastModifyDate:　2024-03-27T09:55:21    Author:   superFBI

#LastModifyDate:　2024-03-26T19:03:40    Author:   superFBI
...
def Inits():
	try:
		...
		pass
	stream["meta_name"] = "[ZNSM]分发主流程"
	stream["meta_desc"] = "分发/tmp/znsm_main数据到unix_udp"
	...
	stream["source"]= {"unix_udp":"/tmp/znsm_main","mode":"json"}
...
def Events(o,topic=''):
	if o["event_type"]=="http" and stream["protocol"]["http_key"]=="true":
		...
		if url:
			...
			to_unix_udp_n(o,"/tmp/yuans_http",8)
		...
		to_unix_udp_n(o,"/tmp/yuan_dbms",8)
