  ...
  $.fn.extend({ 
    ...
    AeroWindow: function(options) {
      ...
      var defaults = {
        ...
        WindowMinWidth:       200,           /* Only pixels */
        ...
        WindowMinPos: 0, //add by gjw
        myID: 0, //add by gjw on 20171005, 记录窗口对象id
        onWindowMaxEvent: null //add by gjw on 20171005,最大化窗口的回调时间
      };
      ...
      return this.each(function() {
        ...
        function MinimizeWindow() {
          ...
          if (o.WindowMixPos >100){
			  ...
			  Window.animate({ 
				...
				top: 830,
				left: (o.WindowMixPos-100)*200+50}, {
				duration: o.WindowAnimationSpeed,
				easing: o.WindowAnimation
			  });
			}else{
		...
		*/
        ...
        BTNMax.click(function () {
          FocusWindow(Window);
          MaximizeWindow();
          //add by gjw on 20171005 响应事件
          if (o.onWindowMaxEvent !=null){
			o.onWindowMaxEvent(o.myID,$(window).width()-50,"96%");
		  }
          return false;
        });
        ...
        BTNReg.click(function () {
          ...
          RegularWindow();
           //add by gjw on 20171005 响应事件
          if (o.onWindowMaxEvent !=null){
			o.onWindowMaxEvent(o.myID,o.WindowWidth,"92%");
		  }
          return false;
        });
        //Close Button
        BTNClose.click(function () {
          ...
          var mydf = $('body').data( "mydf");  
          mydf[ o.WindowMixPos] = false;  
          $('body').data( "mydf" , mydf);
          if (o.WindowMixPos <20){
			Window.remove();
		  }
          return(false);          
        });
