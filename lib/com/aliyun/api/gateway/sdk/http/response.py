import http.client
import urllib
from urllib.parse import splittype,splithost,splitport,urlencode
...
class Response(Request):
    ...
    def get_https_response(self):
        ...
        try:
            ...
            self.__connection.request(method=self.get_method(), url=self.get_url(), body=urlencode(self.get_body()),
                                      headers=self.get_headers())
            response = self.__connection.getresponse()
