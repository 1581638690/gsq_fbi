...
# -*- coding: utf-8 -*- 
#FBI脚本的py文件
#filename: api_mon_visit
#datetime: 2024-08-30T16:10:55.413096
#copyright: OpenFBI
...
def fbi_main(ptree):
	...
	try:
		...
		add_the_error('[api_mon_visit.fbi]执行第[8]原语 run zts_Audit_overview.fbi 出错, 原因: <font color="#FF9900">'+e.__str__()+'</font>')
